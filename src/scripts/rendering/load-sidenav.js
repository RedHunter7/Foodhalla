import { hideSidenav } from '../utility/sidenav.js';
  ...
  fetch(`./sidenav/${page}.html`)
    ...
    .then((result) => {
      ...
      if (page === 'theme-menu') {
        ...
        const favorLink = document.getElementById('favor');
        favorLink.addEventListener('click', () => {
          renderSidenav('favor-menu');
        });
      } else if (page == 'favor-menu') {
        // CLick back button to load main sidenav
        const backBtn = document.getElementById('back-nav');
        backBtn.addEventListener('click', () => {
          renderSidenav('main-menu');
        ...
        const resto = document.getElementById('resto-mobile');
        const meal = document.getElementById('meal-mobile');
